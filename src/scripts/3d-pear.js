...
var canvas_er = document.querySelector('.webgl-birne');
...
loader_er.load('./scene_birne.gltf', function(gltf){
    console.log(gltf);
    canObj_er = gltf.scene;
    canObj_er.scale.set(7.5,7.5,7.5);
...
pointLight_er.position.set(200,10,130);
