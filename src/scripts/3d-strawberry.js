...
var canvas_er = document.querySelector('.webgl-erdbeere');
...
loader_er.load('./scene_erdbeere.gltf', function(gltf){
    console.log(gltf);
    canObj_er = gltf.scene;
    canObj_er.scale.set(8,8,8);
...
pointLight_er.position.set(20,120,10);
pointLight_er.intensity=1;
...
/* Kamera ------------------------------------------------------------------------------------------------*/
var camera_er = new THREE.PerspectiveCamera(75, sizes.width/sizes.height, 0.1, 10000);
camera_er.position.set(40,35,15);
