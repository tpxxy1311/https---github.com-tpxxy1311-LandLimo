...
var canvas_er = document.querySelector('.webgl-orange');
...
loader_er.load('./scene_orange.gltf', function(gltf){
    console.log(gltf);
...
camera_er.position.set(25,40,15);
