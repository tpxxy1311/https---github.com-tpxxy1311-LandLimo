...
var canvas_er = document.querySelector('.webgl-minze');
...
loader_er.load('./scene_minze.gltf', function(gltf){
    console.log(gltf);
...
pointLight_er.position.set(5,5,5);
...
camera_er.position.set(20,39,2);
