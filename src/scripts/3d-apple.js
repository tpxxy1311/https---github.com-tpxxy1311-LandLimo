...
var canvas_er = document.querySelector('.webgl-apfel');
...
loader_er.load('./scene_apfel.gltf', function(gltf){
    console.log(gltf);
    canObj_er = gltf.scene;
    canObj_er.scale.set(13,13,13);
    canObj_er.rotation.y += 0;
...
pointLight_er.position.set(2000,110,130);
pointLight_er.intensity=0.7;
...
/* Kamera ------------------------------------------------------------------------------------------------*/
var camera_er = new THREE.PerspectiveCamera(60, sizes.width/sizes.height, 0.1, 10000);
camera_er.position.set(35,50,40);
