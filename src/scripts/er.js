...
import { load3d_strawberry } from './3d-strawberry';
import { load3d_rhabarber } from './3d-rhabarber';
...
const fadeInRedCan = () =>{
  gsap.from('.webgl-er', { opacity: 0, x:100, duartion:1, delay:2});
}
